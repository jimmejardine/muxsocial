 ...
 */
export function TimelineArea({ timelines, on_remove, on_add_source, on_set_name }: TimelineAreaProps) {
	...
	return (
		<div className={classes.area}>
			{timelines.map((timeline, index) => (
				<Timeline key={timeline.id} timeline={timeline} index={index} on_remove={on_remove} on_add_source={on_add_source} on_set_name={on_set_name} />
			))}
		</div>
	);
}
